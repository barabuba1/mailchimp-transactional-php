...
use MailchimpTransactional\Api\MctemplatesApi;
...
class Configuration
{
    protected $host = 'https://mandrillapp.com/api/1.3';
    protected $apiKey = '';
    ...
    public function __construct()
    {
        ...
        $this->mctemplates = new MctemplatesApi($this);
    ...
    public function getRequestOptions() {
        return [
            ...
            'headers' => [
                'User-Agent' => 'MailchimpTransactional-PHP/1.4.1'
            ]
        ];
    }
